...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', dpi=300}
knitr::include_graphics("../outputs/historico_1.png")
```
...
knitr::include_graphics("../outputs/historico_2.png")
```
...
```{r echo=FALSE, fig.align='center', dpi=300}
knitr::include_graphics("../outputs/historico_3.png")
```
...
```{r echo=FALSE, fig.align='center', dpi=300}
knitr::include_graphics("../outputs/orcamento.png")
```



---
# Notas de avaliação - Média de notas avaliativas no IMDB por pontuação


```{r echo=FALSE, fig.align='center', dpi=300}
knitr::include_graphics("../outputs/notas.png")
```
...
-- 
Obrigado por ler esse materiala até aqui!

Atenciosamente, Maykon.
